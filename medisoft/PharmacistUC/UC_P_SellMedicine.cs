...
namespace medisoft.PharmacistUC
{
    ...
    public partial class UC_P_SellMedicine : UserControl
    {
        ...
        {
            listBoxMecines.Items.Clear();
            query = "select mname from medic where eDate >= getdate() and quantity >'0'";
            ds = fn.getData(query);

            for(int i=0;i<ds.Tables[0].Rows.Count;i++)
            {
                listBoxMecines.Items.Add(ds.Tables[0].Rows[i][0].ToString());
            }
        }
        ...
        private void listBoxMecines_SelectedIndexChanged(object sender, EventArgs e)
        {
            txtNoOfUnits.Clear();
            String name = listBoxMecines.GetItemText(listBoxMecines.SelectedItem);
        ...
        protected Int64 quantity, newQuantity=0;
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            if(valueId !=null)
            {
                ...
                finally
                {
                    ...
                    labelPrice.Text = "Tk. " + totalAmount.ToString();
                }
                UC_P_SellMedicine_Load(this, null);
        ...
        private void btnPurchase_Click(object sender, EventArgs e)
        {
            ...
            print.Footer = "Total Payable Amount: " + labelPrice.Text;
            print.FooterSpacing = 15;
            print.PrintDataGridView(guna2DataGridView1);
            totalAmount = 0;
            labelPrice.Text = "Tk. 00";
